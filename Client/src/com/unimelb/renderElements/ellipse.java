...
public class ellipse implements IRenderable {
    private ArrayList<Point> points;
    private Color color;
    private int strokeWidth;
    private renderTypes type;

    public ellipse(ArrayList<Point> points, Color color, int strokeWidth, renderTypes type) {
        this.points = points;
        this.color = color;
    ...
    public ellipse(IRenderable renderable) {
    ...
    public void renderSelf(Graphics2D g2d) {
        ...
        g2d.draw(new Ellipse2D.Double(topLeft.getX(), topLeft.getY(), width, height));
    }
